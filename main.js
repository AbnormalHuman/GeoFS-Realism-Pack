...
function realismGo() {
   ...
   ui.notification.showOnce("Today's updates: fixed spoiler arming system.")
}
...
500)
    ...
    var script2 = document.createElement("script");
    script2.src = "https://raw.githack.com/AbnormalHuman/GeoFs-Carrier-Catapults-from-AriakimTaiyo/main/catapultsY.js";
    document.body.appendChild(script2);
    script2.onload = function () {
        runCatapults();
    };
  ...
  function checkOverlays() {
    ...
    geofs.runways.setRunwayModelVisibility(0.5)
    }
